...
import com.example.a71190496_final.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("547666960935-og55v3rus4vosubnlhibop32k0eqbej2.apps.googleusercontent.com")
            .requestEmail()
            .build()
    ...
    private fun updateUI(user: FirebaseUser?) {
        if (user != null) {
            val intent = Intent(applicationContext, BukuActivity::class.java)
